...
<div className={styles.teacherName}><h4> {props.name} {props.lastname} </h4></div>
...
{props.disabled? 
<button className={styles.addButtonDisabled} whileHover={{scale:1.05}} disabled={props.disabled} onClick={ () => {navigate(`/${props.navigate}`); localStorage.setItem("SelectedCourse", props.selectedCourseId)}}  >{props.button}</button>
:
<button className={styles.addButton} whileHover={{scale:1.05}} disabled={props.disabled} onClick={ () => {navigate(`/${props.navigate}`); localStorage.setItem("SelectedCourse", props.selectedCourseId); props.clickFuntion(); }} >{props.button}</button>
}
</div>
